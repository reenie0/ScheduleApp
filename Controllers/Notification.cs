...
public class NotificationController : Controller
{
    ...
    private static List<Notification> notifications = new List<Notification>
    {
        new Notification
        {
            ...
            Student = new Student { StudentId = 1, FirstName = "Maureen", LastName = "Sakala", Email = "student@example.com", StudentNumber = "bit2022167", HashedPassword="well", Program="ict", Password="well"},
            Lecturer = null
        }
    };
