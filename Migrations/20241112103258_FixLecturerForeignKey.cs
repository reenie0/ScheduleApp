    ...
    public partial class FixLecturerForeignKey : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerSchedules", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "LecturerSignupModels",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerSignupModels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerScheduleId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schedules", x => x.ScheduleId);
                    table.ForeignKey(
                        name: "FK_Schedules_LecturerSchedules_LecturerScheduleId",
                        column: x => x.LecturerScheduleId,
                        principalTable: "LecturerSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Schedules_Lecturers_LecturerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentRequests_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "ScheduleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentRequests_Students_StudentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailableSlots_Lecturers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AvailableSlots_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_Lecturers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_Lecturers_LecturerId1",
                        column: x => x.LecturerId1,
                        principalTable: "Lecturers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Requests_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "ScheduleId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_Schedules_ScheduleId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_ScheduleId",
                table: "AppointmentRequests",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_StudentId1",
                table: "AppointmentRequests",
                column: "StudentId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableSlots_LecturerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableSlots_StudentId",
                table: "AvailableSlots",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_LecturerId1",
                table: "Requests",
                column: "LecturerId1");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_ScheduleId",
                table: "Requests",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_ScheduleId1",
                table: "Requests",
                column: "ScheduleId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_LecturerId1",
                table: "Schedules",
                column: "LecturerId1");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_LecturerScheduleId",
                table: "Schedules",
                column: "LecturerScheduleId");
        }
